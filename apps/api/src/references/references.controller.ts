...
export class ReferencesController {
  ...
  async analyze(@Param('advanceId') advanceId: string) {
    // Ejecutar directamente para devolver resultado inmediato
    await this.referencesService.analyze(advanceId);
    return { message: 'Análisis de referencias completado', advanceId };
  }
